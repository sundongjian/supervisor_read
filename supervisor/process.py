...
class Subprocess(object):
    ...
    laststart = 0 # Last time the subprocess was started; 0 if never  最后一次启动时间
    laststop = 0  # Last time the subprocess was stopped; 0 if never  最后一次停止时间
    ...
    def spawn(self):
        ...
        实在找不到谁调用了本函数，所以我写一个错误往上抛出一下
        10/0
        error: <class 'xmlrpclib.ProtocolError'>, <ProtocolError for 127.0.0.1/RPC2: 500 Internal Server Error>: file:
        /home/sunjian/kaiyuan/supervisor/supervisor/xmlrpc.py line: 547
        """
    ...
    def stop(self):
        ...
        return self.kill(self.config.stopsignal) # 15
    ...
    def transition(self):
        ...
        # print(self.config.options.mood,state)
