...
class SystemNamespaceRPCInterface:
    def __init__(self, namespaces):
        # namespaces:('supervisor', < supervisor.rpcinterface.SupervisorNamespaceRPCInterface instance at >
        self.namespaces = {}
        for name, inst in namespaces:
            self.namespaces[name] = inst
        # self.namespaces['supervisor'] = SupervisorNamespaceRPCInterface instance
...
def traverse(ob, method, params):
    ...
    # print('rpcinterface',rpcinterface)
